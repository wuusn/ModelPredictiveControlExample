...
public class PowerExample {
     ...
     */
    private static final int SCHEDULING_INTERVAL = 100000;
    ...
    public PowerExample() {
        ...
        System.out.println("Ennegy Consumption: " + ((DatacenterSimple)datacenter0).getPower());
    }
    ...
    private Host createPowerHost() {
        ...
        final PowerModel powerModel = new PowerModelSpecPowerIbmX3250XeonX3470();
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        for (int i = 0; i < CLOUDLETS; i++) {
            ...
            //final long length = CLOUDLET_LENGTH * 2;
            Cloudlet cloudlet =
